// قائمة الخطوط الجديدة من Bunny Fonts
const ALL_FONTS = [
    ...
    { name: "Bowlby One SC", family: "'Bowlby One SC', display", demo: "SC" },
    { name: "Bruno Ace", family: "'Bruno Ace', display", demo: "Ace" },
    ...
    { name: "Chathura", family: "'Chathura', sans-serif", demo: "Telugu" },
    { name: "Cinzel", family: "'Cinzel', serif", demo: "Serif" },
    { name: "Cute Font", family: "'Cute Font', display", demo: "Cute" },
    { name: "Damion", family: "'Damion', cursive", demo: "Cursive" },
    { name: "Diplomata", family: "'Diplomata', serif", demo: "Display" },
    { name: "Dokdo", family: "'Dokdo', display", demo: "Korean" },
    ...
    { name: "Erica One", family: "'Erica One', sans-serif", demo: "One" },
    ...
    { name: "IBM Plex Sans Arabic", family: "'IBM Plex Sans Arabic', sans-serif", demo: "IBM" },
    { name: "Jacquard 12 Charted", family: "'Jacquard 12 Charted', display", demo: "Jacquard" },
    { name: "Jacquard 24 Charted", family: "'Jacquard 24 Charted', display", demo: "Charted" },
    { name: "Jacquarda Bastarda 9", family: "'Jacquarda Bastarda 9', serif", demo: "Bastarda" },
    { name: "Jersey 25 Charted", family: "'Jersey 25 Charted', display", demo: "Jersey" },
    { name: "Jomhuria", family: "'Jomhuria', cursive", demo: "Arabic" },
    ...
    { name: "Noto Kufi Arabic", family: "'Noto Kufi Arabic', sans-serif", demo: "Arabic" },
    { name: "Palette Mosaic", family: "'Palette Mosaic', display", demo: "Mosaic" },
    { name: "Rock Salt", family: "'Rock Salt', cursive", demo: "Salt" },
    { name: "Rubik Beastly", family: "'Rubik Beastly', display", demo: "Beastly" },
    { name: "Rubik Broken Fax", family: "'Rubik Broken Fax', display", demo: "Fax" },
    ...
    { name: "Sancreek", family: "'Sancreek', serif", demo: "Sancreek" },
    { name: "Sixtyfour", family: "'Sixtyfour', monospace", demo: "Pixel" },
    { name: "Sonsie One", family: "'Sonsie One', cursive", demo: "Sonsie" }
];
